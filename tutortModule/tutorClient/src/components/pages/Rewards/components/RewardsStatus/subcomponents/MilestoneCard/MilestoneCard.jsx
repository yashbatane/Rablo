            ...
            <div className="card-end">
                ...
                <div className="card-end-right">
                    ...
                    <div className="end-right-two">
                        {
                            props.data.body.status.isDone ?
                                <button style={{ background: "#15DB1D80" }}>
                                    <svg width="11.5" height="11.25" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5.86117 11.7836C5.56102 11.7836 5.27588 11.6622 5.06578 11.4498L0.818599 7.15496C0.383384 6.71486 0.383384 5.98641 0.818599 5.54631C1.25381 5.10621 1.97417 5.10621 2.40939 5.54631L5.86117 9.03679L13.575 1.23633C14.0102 0.796224 14.7306 0.796224 15.1658 1.23633C15.601 1.67643 15.601 2.40488 15.1658 2.84498L6.65656 11.4498C6.44646 11.6622 6.16132 11.7836 5.86117 11.7836Z" fill="white" />
                                    </svg>
                                    Completed</button>
                                :
