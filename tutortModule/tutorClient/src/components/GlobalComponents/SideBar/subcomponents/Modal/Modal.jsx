...
function Modal(props) {
  ...
  return (
    <div className="modalParent" style={{ position: "absolute", height: "100vh", width: "100%", backgroundColor: "rgba(0, 0, 0, 0.30)", marginTop: "-274px", zIndex: 1, justifyContent: "center", alignItems: "center", display: "flex" }}>
      <div className="modalBackground">
        <div className="modalContainer">
          ...
          <div className="title">
            ...
            <h1 style={{ color: "rgba(101, 6, 6, 0.80)", fontSize: "1.438rem" }}>Leaving So Soon ?</h1>
          </div>
          <div className="body">
